...
const SECCIONES: { titulo: string; texto: string }[] = [
  {
    ...
    texto:
      'BeautyApp es una plataforma que conecta a personas que buscan servicios de belleza y bienestar con profesionales independientes que los ofrecen. BeautyApp no presta los servicios de belleza: actúa como intermediaria entre clientes y profesionales.',
  },
  {
  ...
  {
    titulo: '3. Reservas, señas y pagos',
    texto:
      'Al reservar un turno te comprometés a asistir o cancelarlo con anticipación razonable. Algunas profesionales requieren el pago de una seña para confirmar la reserva. Los pagos dentro de la plataforma se procesan a través de MercadoPago; BeautyApp no almacena datos de tarjetas. Las políticas de devolución de señas dependen de cada profesional.',
  },
  {
    titulo: '4. Cancelaciones',
    texto:
      'Podés cancelar un turno desde la app. Las cancelaciones reiteradas sin aviso o la inasistencia pueden derivar en la limitación del uso de la plataforma.',
  },
  {
    titulo: '5. Responsabilidad por los servicios',
    texto:
      'Los servicios son prestados por profesionales independientes, quienes son responsables de su calidad, seguridad e higiene. BeautyApp no garantiza resultados ni se responsabiliza por daños derivados de la prestación del servicio, sin perjuicio de los derechos que te correspondan como consumidor.',
  },
  {
  ...
  },
  {
    ...
    texto:
      'Recopilamos los datos que cargás en tu perfil (nombre, email, teléfono, direcciones, fecha de nacimiento) y los datos de uso necesarios para operar la plataforma. Los usamos para gestionar reservas, enviarte recordatorios y mejorar el servicio. No vendemos tus datos a terceros. Compartimos con la profesional únicamente la información necesaria para prestar el servicio (tu nombre, teléfono y, si el servicio es a domicilio, la dirección que elijas).',
  },
  {
  ...
  },
  {
    ...
    texto:
      'Si activás las notificaciones, te enviaremos recordatorios de tus turnos según la configuración que elijas. Podés desactivarlas en cualquier momento desde tu perfil o desde la configuración del teléfono.',
  },
  {
